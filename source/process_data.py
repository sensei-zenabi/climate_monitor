    ...
    for file_name in os.listdir(folder_path):
        ...
        if file_name.endswith(".txt"):
            ...
            if file_name[0].isnumeric():
                ...
                df_buoys = pd.concat([df_buoys, df_mean], ignore_index=True)
                
                df_buoys = df_buoys.sort_values(by="BUOY ID")
                
    print(df_buoys.round(2).to_string(index=False))
